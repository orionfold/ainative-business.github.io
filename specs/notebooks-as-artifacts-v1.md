...
render badges on artifact cards. **Update `NARRATIVE-CONTRACT.md`** to slot the badge row
...
- HF READMEs show the badge row above-the-fold; `NARRATIVE-CONTRACT.md` updated + consistent.
