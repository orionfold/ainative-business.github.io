...
Six queries through the chain — three answerable from the 2004 AG-News corpus ingested in the [pgvector article](/field-notes/pgvector-on-spark/), three deliberately outside it. The strict scaffold should ground the first group and refuse the second:
