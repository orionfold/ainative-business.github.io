# Arena Field Edition — `getarena.orionfold.com` bootstrap
...
| `getarena.orionfold.com` DNS | **Website/commerce peer** |
...
```sh
curl -fsSL https://getarena.orionfold.com | OF_LICENSE_URL='https://<supabase-signed-url>' sh
```
...
```sh
curl -fsSL https://getarena.orionfold.com \
