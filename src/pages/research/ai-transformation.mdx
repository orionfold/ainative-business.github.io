...
{/* Advisory CTA is hidden until ainative.business is verified in Resend. Flip to true to re-enable the "Book a Conversation" block below. */}
export const showEmailCTA = false
