...
description: "Workspace briefing, execution lanes, task detail, and live operational signals across ainative-business."
---
...
`ainative-business` uses two complementary workspace views. The **home screen** is the operational briefing for the entire workspace, while the **dashboard** is the active execution board for tasks moving through the system.
...
**Product Team** · *Team lead opening `ainative-business` at 9 AM*
