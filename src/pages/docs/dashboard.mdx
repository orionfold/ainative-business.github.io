...
<BrowserFrame src="/screenshots/tasks-below-fold.png" alt="Dashboard kanban board below fold with additional task cards across Planned, Queued, Running, and Completed columns" />
...
<BrowserFrame src="/screenshots/tasks-list.png" alt="Dashboard table view filtered by running status showing tasks and workflows with priority and project" />
...
<BrowserFrame src="/screenshots/workflows-blueprints.png" alt="Playbook with Master Mode, feature adoption grid across all surfaces, and guided journey cards" />
