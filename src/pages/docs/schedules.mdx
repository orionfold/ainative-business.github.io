...
![Schedules list showing active, paused, and heartbeat schedules](/screenshots/schedules-list.png)
...
![Schedule detail sheet showing configuration and firing history](/screenshots/schedules-detail.png)
...
![Schedule creation form with max agent steps and budget controls](/screenshots/schedules-create-form-empty.png)
...
![Schedule creation form filled with realistic data](/screenshots/schedules-create-form-filled.png)
