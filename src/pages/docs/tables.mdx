...
![Empty create-table form](/screenshots/tables-create-form-empty.png)
*New table dialog with empty name, description, and column builder — set up a fresh table from scratch.*

![Filled create-table form with multiple columns](/screenshots/tables-create-form-filled.png)
