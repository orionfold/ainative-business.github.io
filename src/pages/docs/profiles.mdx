...
![Agent profiles catalog showing profile cards](/screenshots/profiles-list.png)
*The profiles catalog displays agent profiles as cards with name, description, runtime badges, and capability indicators.*

![Profile detail page](/screenshots/profiles-detail.png)
...
![Empty new-profile form](/screenshots/profiles-create-form-empty.png)
*New Profile dialog with empty fields — name, description, system prompt, allowed tools, and runtime preferences.*

![Filled new-profile form](/screenshots/profiles-create-form-filled.png)
