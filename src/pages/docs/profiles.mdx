...
When a task, workflow step, or schedule runs, `ainative-business` can attach one of these profiles so the execution layer starts from an explicit operational contract rather than an ad hoc prompt.
