...
- **Response History** — `ainative-business` preserves whether a request has been handled already, preventing duplicate decision-making.
...
When a running task needs human input, `ainative-business` creates an inbox item and waits for the response. That input might be a permission review, a direct answer to a question, or simply a signal that a run finished or failed.
