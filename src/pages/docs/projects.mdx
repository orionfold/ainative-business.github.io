...
![Projects list view](/screenshots/projects-list.png)
*Project cards showing name, status, and description for each workspace*

![Project detail view](/screenshots/projects-detail.png)
...
![Empty new-project form](/screenshots/projects-create-form-empty.png)
*New Project dialog ready for input — name, description, and optional working directory.*

![Filled new-project form](/screenshots/projects-create-form-filled.png)
