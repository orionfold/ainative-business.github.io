...
title: "Instance API"
description: "Manage ainative-business instance lifecycle — read configuration and guardrails, run initialization, detect and apply upstream upgrades, and poll upgrade availability."
---
