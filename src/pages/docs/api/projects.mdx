...
Create a project pointing to a local codebase — `ainative-business` automatically scans the directory for environment details (language, framework, dependencies):
